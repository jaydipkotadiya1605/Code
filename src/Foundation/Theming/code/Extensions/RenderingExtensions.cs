namespace Sitecore.Foundation.Theming.Extensions
{
    ...
    public static class RenderingExtensions
    {
        ...
        public static string GetSectionClass([NotNull] this Rendering rendering)
        {
            return rendering.Parameters[Constants.HasContainerLayoutParameters.SectionCssClass];
        }
        public static string GetRowClass([NotNull] this Rendering rendering)
        {
            return GetStyle(rendering, Constants.HasContainerLayoutParameters.RowCssClass);
        }
        public static string GetColumnClass([NotNull] this Rendering rendering)
        {
            return GetStyle(rendering, Constants.HasContainerLayoutParameters.ColCssClass);
        }
